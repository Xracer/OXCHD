...
NewBattleState::NewBattleState() : _craft(0)
{
	...
	_txtMapOptions = new Text(160, 15, 240, 170);
	_frameLeft = new Frame(200, 160, 240, 185);

	_txtDarkness = new Text(120, 15, 250, 195);
	_slrDarkness = new Slider(180, 25, 250, 210);

	_txtTerrain = new Text(120, 15, 250, 240);
	_cbxTerrain = new ComboBox(this, 180, 25, 250, 255);

	_txtDepth = new Text(120, 15, 250, 285);
	_slrDepth = new Slider(180, 25, 250, 300);

	_txtAlienOptions = new Text(160, 15, 450, 170);
	_frameRight = new Frame(200, 160, 450, 185);

	_txtDifficulty = new Text(120, 15, 460, 195);
	_cbxDifficulty = new ComboBox(this, 180, 25, 460, 210);

	_txtAlienRace = new Text(120, 15, 460, 240);
	_cbxAlienRace = new ComboBox(this, 180, 25, 460, 255);

	_txtAlienTech = new Text(120, 15, 460, 285);
	_slrAlienTech = new Slider(180, 25, 460, 300);

...
BriefingState::BriefingState(Craft *craft, Base *base)
{
	...
	_btnOk = new TextButton(160, 22, 400, 500);
	_txtTitle = new Text(300, 32, 300, 124);
	_txtTarget = new Text(300, 20, 300, 140);
	_txtCraft = new Text(300, 20, 300, 160);
	...
	if (!deployment) // none defined - should never happen, but better safe than sorry i guess.
	{
		...
		_musicId = "GMDEFEND";
		_window->setBackground(_game->getMod()->getSurface("HDBACK16.SCR"));
	}
	else
	{
